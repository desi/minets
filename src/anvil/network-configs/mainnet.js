...
function getMainnetContractStorages(addressWithoutPrefix) {
    ...
    const MAINNET_BALANCE_SEED = [
      ...
      {
        address: MAINNET_CONTRACT_ADDRESSES.WETH,
        index: `${keccak256(hexToString(STORAGE_SLOT.WETH))}`,
        value: "0x000000000000000000000000000000000000000000000002B5E3AF16B1880000"
      },
      {
        address: MAINNET_CONTRACT_ADDRESSES.MATIC,
        index: `${keccak256(hexToString(STORAGE_SLOT.MATIC))}`,
        value: "0x000000000000000000000000000000000000000000000002B5E3AF16B1880000"
      },
      {
        address: MAINNET_CONTRACT_ADDRESSES.UNI,
        index: `${keccak256(hexToString(STORAGE_SLOT.UNI))}`,
        value: "0x000000000000000000000000000000000000000000000002B5E3AF16B1880000"
      },
      {
        address: MAINNET_CONTRACT_ADDRESSES.BNB,
        index: `${keccak256(hexToString(STORAGE_SLOT.BNB))}`,
        value: "0x000000000000000000000000000000000000000000000002B5E3AF16B1880000"
      },
      {
        address: MAINNET_CONTRACT_ADDRESSES.STAT,
